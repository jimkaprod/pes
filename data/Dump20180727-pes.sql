...
CREATE TABLE `competitions` (
  ...
  `game_name` text,
  `real_name` text,
  `teams_type_id` int(11) DEFAULT NULL,
  `competitions_type_id` int(11) DEFAULT NULL,
  `competitions_level_id` int(11) DEFAULT NULL,
...
-- Dump completed on 2018-07-27 16:58:30
