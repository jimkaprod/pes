...
CREATE TABLE roles (
	id INTEGER NOT NULL, 
	name VARCHAR(64), confirmed BOOLEAN, `default` BOOLEAN, permissions INTEGER, 
	PRIMARY KEY (id), 
	UNIQUE (name)
);
INSERT INTO roles VALUES(1,'User',NULL,1,7);
INSERT INTO roles VALUES(2,'Moderator',NULL,0,15);
INSERT INTO roles VALUES(3,'Administrator',NULL,0,31);
CREATE TABLE alembic_version (
	version_num VARCHAR(32) NOT NULL, 
	CONSTRAINT alembic_version_pkc PRIMARY KEY (version_num)
);
INSERT INTO alembic_version VALUES('6dc926f0d022');
CREATE TABLE users (
	id INTEGER NOT NULL, 
	email VARCHAR(64), 
	username VARCHAR(64), 
